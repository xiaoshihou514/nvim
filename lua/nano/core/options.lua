...
vim.opt.clipboard = "unnamedplus"                       -- allows neovim to access the system clipboa allowsrd
...
vim.opt.completeopt:append("menuone,noselect,noinsert") -- disable the small preview split
